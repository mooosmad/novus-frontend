          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  type="button"
                  className="px-4 py-2 bg-blue text-white rounded-lg hover:bg-blue-950 transition-colors"
                >
                  Ajouter
                </button>
              </div>
                  ...
                  {steps.map((step, index) => (
                    <div key={step.id} className="flex items-center">
                      ...
                      <span className={`ml-2 text-sm font-medium ${
                        currentStep >= step.id ? 'text-blue' : 'text-gray-400'
                      }`}>
                        {step.title}
                      </span>
                      {index < steps.length - 1 && (
                        <div className={`w-16 h-0.5 mx-4 ${
                          currentStep > step.id ? 'bg-blue' : 'bg-gray-300'
                        }`} />
                      )}
                    </div>
                  ))}
                ...
                <div className="flex gap-4">
                  ...
                  {currentStep < steps.length ? (
                    <button
                      type="button"
                      onClick={nextStep}
                      className="px-6 py-3 bg-blue text-white font-medium rounded-lg hover:bg-blue-950 transition-all duration-200"
                    >
                      Suivant
                    </button>
                  ) : (
